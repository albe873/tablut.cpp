...
protected:
    ...
    GameTest() : initialState(), // Use default constructor for initial state
                 game(initialState,
                      ...
                      testUtility) {}          // Use the test utility function defined above
...
TEST_F(GameTest, GetUtility) {
    ...
    ASSERT_EQ(game.getUtility(terminalState), 1);
    ...
    ASSERT_EQ(game.getUtility(terminalState), 0);
    ...
    ASSERT_EQ(game.getUtility(nonTerminalState), 0);
}
